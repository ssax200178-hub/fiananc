...
const filePath = path.resolve(__dirname, '..', 'components', 'SettingsPage.tsx');
const content = fs.readFileSync(filePath, 'utf8');

const startMarker = '// Helper: parse number';
const endMarker = '\nconst SettingsPage = () =>';
...
const replacement = `// Helper: parse number from Arabic/English string
...
console.log('SUCCESS: PasteExtractorSection replaced. File size:', newContent.length);
